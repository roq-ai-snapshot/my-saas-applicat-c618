  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Empower Your Dining Experience with My SaaS Application: Streamlining Restaurant Management, Table Reservations, and Booking Efficiency for Ultimate Success"
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Empower Your Dining Experience with My SaaS Application: Streamlining Restaurant Management, Table Reservations, and Booking Efficiency for Ultimate Success`}
            </Text>
